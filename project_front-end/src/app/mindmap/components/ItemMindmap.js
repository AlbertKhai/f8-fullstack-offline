...
const ItemMindmap = ({ id: idMindmap, title, desc, createdAt }) => {
  ...
  return (
    <div
      ...
      className={clsx(
        loading && 'opacity-20',
        'relative hover:bg-gray-200 cursor-pointer bg-white shadow flex items-center mb-5 py-2 rounded-lg'
      )}
    >
      ...
      <BtnEditMindmap onLoading={setLoading} idMindmap={idMindmap} title={title} />
      {loading && (
