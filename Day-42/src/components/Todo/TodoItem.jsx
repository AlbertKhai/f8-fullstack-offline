...
export default class TodoItem extends Component {
   ...
   handleSubmit = async (e) => {
      ...
      try {
         ...
         this.props.onLogout({ mess: "Cập nhật todo không thành công", type: "danger", id });
      }
   ...
   handleDeleteTodo = async () => {
      ...
      try {
         ...
         console.error(error.message);
         this.props.onLogout({ mess: "Xoá todo không thành công", type: "danger", id });
      }
      ...
      return (
         <li className="todo-item">
            <form action="" method="post" className="todo-item__inner" onSubmit={(e) => this.handleSubmit(e)}>
               <div className={`wrap__todo-content ${done ? "done" : ""} ${isEdit ? "" : "editing"}`}>
                  <textarea
                     ...
                     <div className="wrap__action-edit">
                        <div className="wrap__todo-done">
                           <input
                              ...
                              type="checkbox"
                              className="checkbox__todo-done"
                              id={`checkboxTodoDone${this.props.index}`}
                           />
                           <label className="label__todo-done" htmlFor={`checkboxTodoDone${this.props.index}`}>
                              <span className={`todo-done ${done ? "done" : ""}`}>
